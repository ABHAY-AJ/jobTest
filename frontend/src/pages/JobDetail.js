      ...
      >
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={12}>
            ...
            <Tag color="magenta">{job?.criteria?.College.join(', ') || 'Any'}</Tag>
          </Col>
          <Col span={12}>
            <Text strong style={{ display: 'block', marginBottom: '8px' }}>Date of Birth:</Text>
            <Tag color="cyan">{job?.criteria?.dateOfBirth ? new Date(job.criteria.dateOfBirth).toLocaleDateString() : 'N/A'}</Tag>
          </Col>
          <Col span={12}>
            <Text strong style={{ display: 'block', marginBottom: '8px' }}>Academic Percentage:</Text>
            <Tag color="red">{job?.criteria?.academicPercentage || 'passed'}%</Tag>
          </Col>
        </Row>

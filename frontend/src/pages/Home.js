...
const Home = () => {
  return (
    <div style={{ textAlign: 'center', padding: '50px', background: '#f0f2f5' }}>
      {/* Carousel */}
      <div className="carousel-container" style={{height:250}}>
        <Carousel
          autoplay
          dots={false}
          slidesToShow={3}
        ...
        >
          <div className="carousel-slide">
            <Card cover={<img alt="example" src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/202405/6641ea0796d7e-skoch-report-514-million-jobs-created-between-2014-and-2024-132302269-16x9.png?size=1200:675" />}>
              <Card.Meta title="Slide 1" description="Description for slide 1" />
            </Card>
          </div>
          <div className="carousel-slide">
            <Card cover={<img alt="example" src="https://clipart-library.com/2023/web-top-jobs10.jpg" />}>
              <Card.Meta title="Slide 2" description="Description for slide 2" />
            </Card>
          </div>
          <div className="carousel-slide">
            <Card cover={<img alt="example" src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/202112/stockvault-job-opportunity2594_1200x768.jpeg?size=1200:675" />}>
              <Card.Meta title="Slide 3" description="Description for slide 3" />
            </Card>
          </div>
          <div className="carousel-slide">
            <Card cover={<img alt="example" src="https://media.telanganatoday.com/wp-content/uploads/2022/06/Job-Vacancy.jpg" />}>
              <Card.Meta title="Slide 4" description="Description for slide 4" />
            </Card>
          </div>
          <div className="carousel-slide">
            <Card cover={<img alt="example" src="https://www.careerguide.com/career/wp-content/uploads/2023/11/Jobs-in-Australia.png" />}>
        ...
        <Row gutter={16} justify="center">
          <Col xs={24} sm={12} md={8}>
            <Card
              ...
              bordered={false}
              cover={<img alt="example" src="https://assets.plan.io/images/blog/become-a-more-productive-software-engineer.png" />}
            >
              <Paragraph>
          ...
          <Col xs={24} sm={12} md={8}>
            <Card
              ...
              bordered={false}
              cover={<img alt="example" src="https://longlist.io/_next/image?url=https%3A%2F%2Fcdn.longlist.io%2Fmarketing_specialist_job_description_3b9cadf273.webp&w=1200&q=75" />}
            >
              <Paragraph>
          ...
          <Col xs={24} sm={12} md={8}>
            <Card
              ...
              bordered={false}
              cover={<img alt="example" src="https://www.liveabout.com/thmb/ss8yMyi_nK15Dp9Vyk4bwq0ydJ8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/graphic-designer-job-description-and-salary-information-2061790-edit-4335087e524b4504b76ae1fea22873cf.jpg" />}
            >
              <Paragraph>
      ...
      <div style={{ marginTop: '50px', background: '#fff', padding: '20px' }}>
